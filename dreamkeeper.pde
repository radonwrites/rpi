...
void setup()
{
  ...
  //sets the correct output for the audio
  ...
  //String[] dreams = {"data/myrecording.wav"};
  ...
  //String newSongFileName = "nshflsie.wav";
...
void pinEvent(int pin)
{
  ...
  if (GPIO.digitalRead(4) == GPIO.LOW) 
  {
    if ( recorder.isRecording() ) 
    {
      ...
      recorder.save();
      println("Done saving.");
      //String newDreamFileName = "data/myrecording - "+new java.util.Date()+".wav";
